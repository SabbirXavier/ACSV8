...
import { Wallet, QrCode, CreditCard, CheckCircle2, AlertCircle, Upload, Clock, Download as DownloadIcon, ExternalLink, UserPlus, Plus, Edit, Trash2, Save, X } from 'lucide-react';
...
export default function TabFee({ branding }: TabFeeProps) {
